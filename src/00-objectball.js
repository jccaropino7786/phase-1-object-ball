...
const homeTeam = (gameStats.home.players)
const awayTeam = (gameStats.away.players)

console.log(homeTeam)
console.log(awayTeam)

console.table(homeTeam)
console.table(awayTeam)
...
console.log(numPointsScored("Lebron"))
